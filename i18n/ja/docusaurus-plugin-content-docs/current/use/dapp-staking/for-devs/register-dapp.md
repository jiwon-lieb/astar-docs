...
#### 1. An [Astar Native developer wallet](/docs/use/manage-wallets/create-wallet) with some tokens to cover gas fee. _No Ledger hardware wallet or EVM wallet._
...
The smart contract can be on Astar Native (WASM) or Astar EVM ([Public Endpoints](/docs/build/environment/endpoints/#public-endpoints)). _(Not on Astar zkEVM)_
...
Connect your native wallet and choose the network on which you are going to register for dApp Staking _(Astar Network or Shiden Network)_;
...
- Contract addres _(automatically filled)_;
- Project URL;
