...
4. You are now on the transfer page. Add the destination Astar Native address and the amount you wish to transfer, then press the confirm button. トランザクションが完了したら、Portalに戻って残高を確認してください。
