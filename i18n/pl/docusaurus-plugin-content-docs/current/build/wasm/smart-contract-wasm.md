...
- Update contract code for an address: replace the contract code at the specified address with new code (see [set\_code\_hash][set_code_hash]). Storage and balances will be preserved.
